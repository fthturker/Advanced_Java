...
import JavaProjects.P04_okulYönetimi.ogrcOgrtYonetimi.Ogrenci;
import JavaProjects.P04_okulYönetimi.ogrcOgrtYonetimi.Ogretmen;
...
public class Islemler {
    ...
    static List<JavaProjects.P04_okulYönetimi.ogrcOgrtYonetimi.Kisi> ogrncListesi = new ArrayList<>();
    ...
    private static void ekle() {
        ...
        if (kisiTuru.equals("OGRENCI")) {
            ...
            JavaProjects.P04_okulYönetimi.ogrcOgrtYonetimi.Ogrenci sefilOgrenci = new Ogrenci(adSoyad, kimlikNo, yas, ogrcNo, sınıf);//p'li cons ogrc obj create edildi
            ...
            JavaProjects.P04_okulYönetimi.ogrcOgrtYonetimi.Ogretmen muhtesemOgretmen = new Ogretmen(adSoyad, kimlikNo, yas, sicilNo, bolum);//p'li cons ogrtm obj create edildi
